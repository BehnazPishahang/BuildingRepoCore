...
namespace Persistence.Migrations
{
    ...
    [Migration("20230129075918_TableSplitting")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Building.BuildingRegion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Cost.Cost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d0b877cd-c6f5-49b5-bde5-9fc707149837"),
                            Amount = 2000m,
                        ...
                        new
                        {
                            Id = new Guid("3167355f-dcd6-49b6-ab6f-0c7ac89166d7"),
                            Amount = 1000m,
            ...
            modelBuilder.Entity("Domain.User.UserAccess", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7e851422-c413-4a98-a45b-2bbf482c0812"),
                            EndDate = "9999/99/99",
                        ...
                        new
                        {
                            Id = new Guid("9cda441a-6ed1-4e0c-b9b9-b058ea2edc29"),
                            EndDate = "9999/99/99",
            ...
            modelBuilder.Entity("Domain.Building.Building", b =>
                {
                    b.OwnsOne("Domain.Building.BuildingHistory", "TheBuildingHistory", b1 =>
                        {
                            ...
                            b1.ToTable("BuildingHistory", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("BuildingId");
                        });

                    b.Navigation("TheBuildingHistory");
                });

            modelBuilder.Entity("Domain.Building.BuildingRegion", b =>
                {
                    b.HasOne("Domain.Building.Building", null)
                        .WithOne("TheBuildingRegion")
                        .HasForeignKey("Domain.Building.BuildingRegion", "Id")
            ...
            modelBuilder.Entity("Domain.Building.Building", b =>
                {
                    b.Navigation("TheBuildingRegion");
